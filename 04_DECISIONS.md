...
None required before specification formalization. Phase-specific `REVIEW_REQUIRED` items remain
at their named gates and are not silently approved by this statement.
