...
- Phase 4 sync protocol can carry supplier-price append and procurement edits without new sync semantics.
...
## P6-M1 — Suppliers + append-only price history
Implement supplier model/API/UI, location/contact, price history, derived metrics, RLS, sync foundation.
...
Implement procurement lifecycle, demand aggregation, quantities, manual edits, grouping/estimate, carry-forward, print/export, neutral assignment, restricted driver projection.
